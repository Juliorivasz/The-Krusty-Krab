...
export const RegisterUser = () => {
    ...
    const registerSubmit = (event) => {
        ...
        if(password == ConfirmPassword) {
            setUser((prevData)=>({...prevData, ['nombre']: nombre, ['email']: email, ['password']: password }));
            setSendSucess(true);
        ...
        <div className="form-container">
            ...
            <div className="cont-form">
                <form onSubmit={registerSubmit}>
                    ...
                    <input type="text" id="fullname" name="fullname" onChange={(e)=>setNombre(e.target.value)} required/>
                    ...
                    <div style={{position: "relative"}}>
                        <input type={showConfirmPass ? "text" : "password"} id="confirm-password" name="confirm-password" onChange={(event) => setConfirmPassword(event.target.value)} required/>
                        <div style={{width: "20px", height: "20px", position: "absolute", top: "13%", right: "3%", cursor: "pointer"}} onClick={()=>{setShowConfirmPass(!showConfirmPass)}}>
                ...
                <div className="signup-section">
                    ...
                    <Link className="create-account-btn" to="/admin">Inicia sesión</Link>
                </div>
            </div>
        </div>
